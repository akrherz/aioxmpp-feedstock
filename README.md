...
Package license: LGPL-3.0-only AND LGPLLR AND GPL-3.0-only
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aioxmpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aioxmpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `aioxmpp` available on your platform:
...
```
pixi search aioxmpp --channel conda-forge
```
